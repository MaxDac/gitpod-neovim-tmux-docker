...
docker build -f gitpod-elixir.dockerfile -t maxdac/gitpod-elixir:1.16.0-otp-26a .
docker tag maxdac/gitpod-elixir:1.16.0-otp-26a maxdac/gitpod-elixir:latest 
